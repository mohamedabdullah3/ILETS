...
export default function CTASection({ onRetakeClick }: Props) {
  return (
    <div className="grid gap-3 md:grid-cols-3">
      <Link href="/writing-sprint" className="rounded-2xl border border-navy/10 bg-white p-4 text-right shadow-sm transition hover:-translate-y-0.5 hover:shadow">
      ...
      <Link href="/training-plan" className="rounded-2xl border border-navy/10 bg-white p-4 text-right shadow-sm transition hover:-translate-y-0.5 hover:shadow">
